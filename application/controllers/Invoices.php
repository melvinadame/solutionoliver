    ...
    function modal_form() {
        ...
        if ($estimate_id || $order_id) {
            ...
            if ($info) {
                ...
                $model_info->discount_amount = $model_info->discount_amount;
                $model_info->discount_amount_type = $model_info->discount_amount_type;
                $model_info->discount_type = $model_info->discount_type;
            }
        }
